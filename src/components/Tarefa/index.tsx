...
import { remover, editar, alteraStatus } from '../../store/reducers/terefas'
...
const Tarefa = ({
  ...
  return (
    <S.Card>
      ...
      <S.BarraAcoes>
        {' '}
        {/* Condicional para verificar se está editando, se sim botao salvar e cancelar, não editar remover */}
        {estaEditando ? (
          <>
            <BotaoSalvar
              onClick={() => {
